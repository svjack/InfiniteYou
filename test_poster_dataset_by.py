...
#from pipelines.pipeline_infu_poster_flux import InfUFluxPipeline
...
def main():
    ...
    #dataset = load_dataset("svjack/Product_Posters_Singer_DESC", split="train")
    #dataset = load_dataset("svjack/Dont_be_your_lover_Black_MV_prompt", split="train")
    dataset = load_dataset("svjack/Dont_be_your_lover_Yellow_MV_prompt", split="train")
    prompts = dataset["mv_prompt"]
